...
public class AtmRepository {
    ...
    private Map<Long, Long> amountAndQuantity = new TreeMap<>(sortByAmountDesc);
    private Map<Long, Long> withdrawlDenominations = new TreeMap<>(sortByAmountDesc);
    ...
    protected void withdrawRecursion(Long withdrawlAmount, Long denminations) {
        ...
        if (withDrawlAmountInHiger$s > 0 && availabe$sQuantityInATM > 0) {
            ...
            withdrawlDenominations = new TreeMap<>(sortByAmountDesc);
